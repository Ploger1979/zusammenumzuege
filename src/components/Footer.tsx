            ...
            <div className="container mx-auto px-4 grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <div className="flex gap-6">
                        <a href="https://www.facebook.com/profile.php?id=61572029682674" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
